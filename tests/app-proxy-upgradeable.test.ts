...
describe("Describe entity assertions", () => {
  beforeAll(() => {
    ...
    let newProxyDepositEvent = createProxyDepositEvent(sender, value)
    handleProxyDeposit(newProxyDepositEvent)
  })
  ...
  test("ProxyDeposit created and stored", () => {
    assert.entityCount("ProxyDeposit", 1)
